    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-6 right-6 h-14 w-14 rounded-full shadow-lg bg-[#9b87f5] hover:bg-[#8b77e5] z-50"
          size="icon"
        >
      ...
      {isOpen && (
        <div 
          className={`fixed bottom-6 right-6 bg-card border-2 border-[#9b87f5]/20 rounded-lg shadow-2xl z-50 flex flex-col transition-all ${
            isMinimized ? 'w-80 h-14' : 'w-96 h-[600px]'
          }`}
        >
          {/* Header */}
          <div className="flex items-center justify-between p-3 border-b border-[#9b87f5]/20 bg-gradient-to-r from-[#9b87f5]/10 to-transparent">
          ...
          {!isMinimized && (
            <>
                ...
                {messages.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {messages.map((msg, idx) => (
                      ...
                      >
                        {msg.role === "assistant" && (
                          <div className="h-6 w-6 rounded-full bg-[#9b87f5] flex items-center justify-center flex-shrink-0">
              ...
              {/* Input Area */}
              <div className="p-3 border-t border-[#9b87f5]/20">
