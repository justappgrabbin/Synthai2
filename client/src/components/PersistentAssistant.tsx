    ...
    <>
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 h-14 w-14 sm:h-16 sm:w-16 rounded-full shadow-2xl bg-lavender hover:bg-lavender-hover z-[99999] touch-manipulation border-2 border-white/20"
          size="icon"
          title="AI Guard Dog 🐕"
        >
