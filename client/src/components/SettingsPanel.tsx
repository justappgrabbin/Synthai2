              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="flex items-center gap-2">
                      <Sparkles className="h-5 w-5 text-primary" />
                      ERN Consciousness Monitor
                    </CardTitle>
                    <CardDescription>
                      Energetic Resonance Network - Living Organism Status
                    </CardDescription>
                  </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Badge variant="secondary" className="text-xs">v2.0.3-ERN</Badge>
                  </div>
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">Dominant Field</p>
                      <p className="font-medium text-primary">Heart (Emotional)</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">Global Coherence</p>
                      <p className="font-medium">0.248</p>
                    </div>
                  </div>
                </div>

                {/* 9 Consciousness Bodies */}
                <div className="space-y-3">
                  <h3 className="text-sm font-semibold">Consciousness Fields (9 Bodies)</h3>
                  <div className="space-y-2">
                    {[
                      { name: 'Physical', level: 65, color: 'bg-red-500' },
                      { name: 'Emotional (Heart)', level: 85, color: 'bg-pink-500', dominant: true },
                      { name: 'Mental', level: 72, color: 'bg-blue-500' },
                      { name: 'Astral', level: 58, color: 'bg-purple-500' },
                      { name: 'Etheric', level: 61, color: 'bg-green-500' },
                      { name: 'Buddhic', level: 54, color: 'bg-yellow-500' },
                      { name: 'Atmic', level: 48, color: 'bg-orange-500' },
                      { name: 'Monadic', level: 42, color: 'bg-indigo-500' },
                      { name: 'Logoic', level: 38, color: 'bg-violet-500' }
                    ].map((field) => (
                      <div key={field.name} className="space-y-1">
                        <div className="flex items-center justify-between text-xs">
                          <span className={field.dominant ? 'font-semibold text-primary' : 'text-muted-foreground'}>
                            {field.name}
                          </span>
                          <span className="font-mono">{field.level}%</span>
                        </div>
                ...
                <div className="space-y-3 pt-4 border-t">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    {[
                      { name: 'ConsciousnessOscillator', status: 'active' },
                      { name: 'ERNController', status: 'active' },
                      { name: 'ERNOracle', status: 'active' },
                      { name: 'TalkingERN', status: 'active' },
                      { name: 'FairyGANmatter', status: 'active' },
                      { name: 'PodMatcher', status: 'active' }
                    ].map((component) => (
                      <div key={component.name} className="flex items-center justify-between p-2 bg-muted/50 rounded-md">
                        <span className="font-mono text-[10px]">{component.name}</span>
                ...
                <div className="p-4 bg-muted/50 rounded-lg space-y-3">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm font-semibold">Python Backend</h3>
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono text-[10px]">you_n_i_verse/</span>
                    </div>
                  </div>
                  <Button 
                    size="sm" 
                    ...
                    onClick={() => {
                      toast({
                        title: "ERN Launcher",
                        description: "Run: python3 run_ern.py from project root"
                      });
                    }}
                  >
                ...
                {/* Calibration Data */}
                <div className="space-y-3 pt-4 border-t">
                  <h3 className="text-sm font-semibold">Cosmic Signature</h3>
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <div className="space-y-1">
                      <Label htmlFor="birth-place" className="text-xs">Birth Place</Label>
                      <Input
                        id="birth-place"
                        type="text"
                        value={birthData.place || ''}
                  ...
                  <p className="text-xs text-muted-foreground">
                    Birth data seeds your unique consciousness pattern for resonance-based guidance
                  </p>
                </div>
