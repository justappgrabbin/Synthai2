...
export const synthWorldRuntime = {
  ...
  sourcePacks: [
    ...
    "resonance_foundry_4_",
    "you_and_i_first_3_",
    "glyph_game_system_1_",
    "motivation_gate_42_",
  ],
  networkLayers: [
    {
      id: "resonance-foundry",
      title: "Resonance Network",
      sourcePack: "resonance_foundry_4_",
      role: "People, groups, opportunities, matching, and program phases.",
      pieces: ["matching", "groups", "opportunities", "oracle", "resonance-score", "program-phase-tracker"],
      status: "source-preserved",
    },
    {
      id: "autoling-builder",
      title: "Autoling Builder",
      sourcePack: "you_and_i_first_3_",
      role: "Classify files, extract specs, organize layouts, self-correct, and feed addresses.",
      pieces: ["file_classifier.py", "spec_extractor.py", "layout_organizer.py", "self_corrector.py", "memory_engine.py"],
      status: "source-preserved",
    },
    {
      id: "glyph-quest",
      title: "Glyph Quest System",
      sourcePack: "glyph_game_system_1_",
      role: "Companion game loop, player state, quests, codons, and resonance engine.",
      pieces: ["player_system.py", "quest_system.py", "resonance_engine.py", "glyph_substrate.py", "codons.py"],
      status: "source-preserved",
    },
    {
      id: "motivation-gate-42",
      title: "Motivation Gate 42",
      sourcePack: "motivation_gate_42_",
      role: "Clean ingestible module example with manifest, resonance map, logic, and UI.",
      pieces: ["manifest.json", "resonance_map.json", "logic_handler.js", "visual_component.jsx"],
      status: "source-preserved",
    },
  ],
  agent: {
